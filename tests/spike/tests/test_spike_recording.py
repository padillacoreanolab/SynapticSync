...
from synapticsync.spike.spike_recording import SpikeRecording
...
class TestSpikeRecording(unittest.TestCase):
    ...
    # fix test error: Argument of type "Unknown | None" cannot be assigned to parameter "obj" of type "Sized" in function "len"
